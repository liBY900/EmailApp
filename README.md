...
How It Works
The program starts in the EmailApp class.
A new Email object is created with the user’s name.
The user is prompted to choose a department.
A random password is generated automatically.
A company email address is created based on the user’s name and department.
The program displays the user’s information.
Example Output
